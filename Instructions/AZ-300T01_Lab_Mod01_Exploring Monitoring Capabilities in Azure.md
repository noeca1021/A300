...
1. From the **Monitor - Alerts** blade, create a new alert rule with the following settings:
    ...
    - Alert rule name: **Percentage CPU of the VM scale set is greater than 60 percent**

    - Description: **Percentage CPU of the VM scale set is greater than 60 percent**
